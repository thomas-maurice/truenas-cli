...
GOFLAGS := -ldflags \
	"\
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.Version=$(VERSION)' \
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.BuildHost=$(shell hostname)' \
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.BuildTime=$(shell date)' \
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.BuildHash=$(HASH)' \
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.OS=$(shell go env GOOS)' \
	-X 'github.com/thomas-maurice/truenas-cli/pkg/version.Arch=$(shell go env GOARCH)' \
	"
